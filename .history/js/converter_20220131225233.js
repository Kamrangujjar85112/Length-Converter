...
const enterin = document.querySelectorAll('.enterfun');
...
// ENTER FUNCTIONALITY
enterin?.addEventListener('keyup', function(event){
...
// inputMiToKm?.addEventListener('keyup', function(event){
...
// });
// inputMToCm?.addEventListener('keyup', function(event){
...
// });
// inputCmToKm?.addEventListener('keyup', function(event){
...
// });
// inputKmToM?.addEventListener('keyup', function(event){
...
// });
// inputMiToM?.addEventListener('keyup', function(event){
...
// });
// inputFValue?.addEventListener('keyup', function(event){
...
// });
// inputSValue?.addEventListener('keyup', function(event){
...
if(inputFValue?.value || inputSValue?.value){
    if(inputFValue?.value  > 0 || inputSValue?.value > 0){
