...
convert.addEventListener('click', function converter(e){
    const Mm = inputCmToMm.value * 10;
    e.document.getElementById('cmToMm').innerHTML = inputCmToMm.value +' Centimeters are equal to ' +Mm + ' Milimeters';
}) 
// Miles to kilometers
