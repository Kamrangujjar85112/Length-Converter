...
// centimeters To kilometers
if(inputCmToKm?.value || inputCmToKm?.value != Number){
...
// centimeters To Milimeters
if(inputCmToMm?.value || inputCmToMm?.value != Number){
...
// Miles to kilometers
if(inputMiToKm?.value || inputMiToKm?.value != Number){
...
// Meters to Centimeters
if(inputMToCm?.value || inputMToCm?.value != Number){
...
// kilometers To meters
if(inputKmToM?.value || inputKmToM?.value != Number){
...
// Miles To Meters
if(inputMiToM?.value || inputMiToM?.value != Number){
...
// percentage
if(inputFValue?.value || inputSValue?.value || inputFValue?.value != Number || inputSValue?.value != Number){
