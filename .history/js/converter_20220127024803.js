...
if(inputCmToKm?.value > 0){
    ...
    document.getElementById('cmToKm').style.display ='none';
...
if(inputCmToMm?.value > 0){
    ...
    document.getElementById('cmToMm').style.display ='none';
...
if(inputMiToKm?.value > 0){
    ...
    document.getElementById('miToKm').style.display ='none';
...
if(inputMToCm?.value > 0){
    ...
    document.getElementById('mToCm').style.display ='none';
...
if(inputKmToM?.value > 0){
    ...
    document.getElementById('kmToM').style.display ='none';
...
if(inputMiToM?.value > 0){
    ...
    document.getElementById('miToM').style.display ='none';
