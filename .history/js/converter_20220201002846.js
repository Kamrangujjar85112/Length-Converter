...
const clear = document.querySelectorAll('.text');



// ENTER FUNCTIONALITY
// enter?.forEach(function(btn){
...
clear?.forEach(function(clearBtn){
    clearBtn.addEventListener('keypress', function(eventClear){

        if(eventClear.keyCode === 8){
